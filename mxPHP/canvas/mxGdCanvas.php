<?php
/**
 * $Id: mxGdCanvas.php,v 1.92 2010/01/02 09:45:16 gaudenz Exp $
			...
			$round = mxUtils::getValue($style, mxConstants::$STYLE_ROUNDED);
 			...
 			if ($shape == mxConstants::$SHAPE_LABEL)
 			{
				...
				if ($image != null)
				{
	 				...
	 				if ($imgAlign == null || $imgAlign == mxConstants::$ALIGN_LEFT)
	 				{
	 					$imgX += $spacing;
	 				}
	 				...
	 				if ($imgValign == null || $imgValign == mxConstants::$ALIGN_MIDDLE)
	 				{
	 					$imgY += ($h - $imgHeight) / 2;
	 				}
	 				else if ($imgValign == mxConstants::$ALIGN_TOP)
	 				{
	 					$imgY += $spacing;
	 				}
