<?php
/**
 * $Id: mxUtils.php,v 1.41 2010/04/27 14:16:28 gaudenz Exp $
...
class mxUtils
{
    ...
    static function getScaledLabelBounds($x, $y, $size, $outerWidth, $outerHeight, $style, $scale)
    {
        ...
        if ((!$horizontal && $align == mxConstants::$ALIGN_LEFT) ||
        	($horizontal && $valign == mxConstants::$ALIGN_BOTTOM))
        {
	 ...
	 */
	static function is($value, $nodeName = null, $attributeName = null, $attributeValue = null)
	{
		if ($value != null &&
			($nodeName == null ||
