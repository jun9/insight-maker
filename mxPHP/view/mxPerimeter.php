<?php
/**
 * $Id: mxPerimeter.php,v 1.15 2010/01/02 09:45:15 gaudenz Exp $
...
interface mxPerimeterFunction
{
	 ...
	 * Parameters:
	 *
	 * bounds - <mxRectangle> that describes the bounds of the terminal.
	 * edgeState - Optional cell state for the connecting edge.
	 * terminalState - Cell state for the connected terminal.
	 * isSource - boolean that specifies if the point is the source of the edge.
	 * next - <mxPoint> that contains the coordinates of the next point on the edge.
	 */
	public function apply($bounds, $edgeState, $terminalState, $isSource, $next);
...
class mxTrianglePerimeter implements mxPerimeterFunction
{
	...
	public function apply($bounds, $edgeState, $terminalState, $isSource, $next)
	{
		...
		$direction = ($terminalState != null) ?
			mxUtils::getValue($terminalState->style, mxConstants::$STYLE_DIRECTION) : null;
