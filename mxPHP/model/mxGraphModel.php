<?php
/**
 * $Id: mxGraphModel.php,v 1.41 2010/01/02 09:45:15 gaudenz Exp $
...
class mxGraphModel extends mxEventSource
{
	 ...
	 */
	function getTerminal($edge, $isSource)
	{
	 ...
	 */
	function setTerminal($edge, $terminal, $isSource)
	{
		$previous = $edge->getTerminal($isSource);
